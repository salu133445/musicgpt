...
class MusicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Transpose all the pitches for k semitones (k~Uniform(-5, 6))
        ...
        # Encode the notes
        seq = representation_compact.encode_notes(notes, self.encoding)
...
def main():
    ...
    # Load the encoding
    encoding = representation_compact.load_encoding(
        args.in_dir / "encoding.json"
    )
